...
class Annotator:
    ...
    def box_label(self, box, label='', font_size=1, color=(128, 128, 128), txt_color=(255, 255, 255)):
        ...
        if self.pil or not is_ascii(label):
            ...
            if label:
                w, h = cv2.getTextSize(label, 0, fontScale=self.lw / 5, thickness=font_size)[0]  # text width, height
                outside = p1[1] - h >= 3
